...
//    string package_path = ros::package::getPath("grabrb_ui");
    photoPath= QDir::currentPath() +QString("/src/rb_grabobj/photo");
...
//    logPath=QString().fromStdString(ros::package::getPath("grabrb_ui"))+QString("/photo/logo.png");
    logPath=QString().fromStdString(ros::package::getPath("rb_grabobj"))+QString("/photo/logo_ros.png");
}
...
//    label_main_logo->setPixmap(QPixmap(logPath));
    ...
    label_tabmain_fsmNode = new QLabel(gBox_tabmain_status);
    label_tabmain_fsmNode->setObjectName(QString::fromUtf8("label_tabmain_fsmNode"));

    gLayout_tabmain_status->addWidget(label_tabmain_fsmNode, 1, 4, 1, 1);
    ...
    gBox_tab_autoMode_img->setStyleSheet(groupBox_qss);
...
//    labeltab_autoMode_image->setPixmap(QPixmap(photoPath+"/question.jpg"));
    ...
    gBox_tab_autoMode_fsm->setStyleSheet(groupBox_qss);
    ...
    gBox_tab_stepMode_showImg->setStyleSheet(groupBox_qss);
    ...
    vLayout_tab_stepMode_11->setStretch(0,1);
    vLayout_tab_stepMode_11->setStretch(1,2);
    ...
    gBox_tab_stepMode_status->setStyleSheet(groupBox_qss);
    ...
    gBox_tab_stepMode_operate->setStyleSheet(groupBox_qss);
    ...
    label_tabmain_gripperConn->setFixedHeight(50);
    label_tabmain_voiceNode->setFixedHeight(50);
    label_tabmain_d435iConn->setFixedHeight(50);
    label_tabmain_kinect2Conn->setFixedHeight(50);
    label_tabmain_visionBridge->setFixedHeight(50);
    label_tabmain_senceFinish->setFixedHeight(50);
    label_tabmain_pickPlaceBridge->setFixedHeight(50);
    label_tabmain_fsmNode->setFixedHeight(50);
    ...
    label_tabmain_gripperConn->setAlignment(Qt::AlignCenter);
    label_tabmain_voiceNode->setAlignment(Qt::AlignCenter);
    label_tabmain_d435iConn->setAlignment(Qt::AlignCenter);
    label_tabmain_kinect2Conn->setAlignment(Qt::AlignCenter);
    label_tabmain_visionBridge->setAlignment(Qt::AlignCenter);
    label_tabmain_senceFinish->setAlignment(Qt::AlignCenter);
    label_tabmain_pickPlaceBridge->setAlignment(Qt::AlignCenter);
    label_tabmain_fsmNode->setAlignment(Qt::AlignCenter);

    label_tab_autoMode_grab->setFixedHeight(50);
    label_tab_autoMode_updatePCL->setFixedHeight(50);
    label_tab_autoMode_detect->setFixedHeight(50);
    label_tab_autoMode_prepare->setFixedHeight(50);
    label_tab_autoMode_init->setFixedHeight(50);
    label_tab_autoMode_exit->setFixedHeight(50);
    label_tab_autoMode_err->setFixedHeight(50);
    label_tab_autoMode_place->setFixedHeight(50);

    label_tab_autoMode_grab->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_updatePCL->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_detect->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_prepare->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_init->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_exit->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_err->setAlignment(Qt::AlignCenter);
    label_tab_autoMode_place->setAlignment(Qt::AlignCenter);

    label_tab_stepMode_pickPlaceBridge->setFixedHeight(50);
    label_tab_stepMode_rd435iConn->setFixedHeight(50);
    label_tab_stepMode_rbIsWell->setFixedHeight(50);
    label_tab_stepMode_rbEnable->setFixedHeight(50);
    label_tab_stepMode_gripperConn->setFixedHeight(50);
    label_tab_stepMode_senceFinish->setFixedHeight(50);
    label_tab_stepMode_perceptionBridge->setFixedHeight(50);
    label_tab_stepMode_dmBridge->setFixedHeight(50);
    label_tab_stepMode_plannerBridge->setFixedHeight(50);
    label_tab_stepMode_motionBridge->setFixedHeight(50);

    label_tab_stepMode_pickPlaceBridge->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_rd435iConn->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_rbIsWell->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_rbEnable->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_gripperConn->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_senceFinish->setAlignment(Qt::AlignCenter);
    label_tab_stepMode_perceptionBridge->setAlignment(Qt::AlignCenter);
...
void BaseWindow::retranslateUi(QMainWindow *MainWindow) {
    ...
    label_tabmain_fsmNode->setText(QApplication::translate("MainWindow", "状态机节点", nullptr));
...
//    label_tab_stepMode_showImg->setText(QApplication::translate("MainWindow", "TextLabel", nullptr));
    ...
    groupBox_tabdebug_2->setTitle(QApplication::translate("MainWindow", "夹爪调试", nullptr));
